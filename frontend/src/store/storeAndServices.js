...
export const studentService = {
   ...
   getChapters:       (p)             => api.get('/student/chapters', { params: p }),
...
export const teacherService = {
   getChapters:   (p)         => api.get('/teacher/chapters', { params: p }),
   createNote:    (data)      => api.post('/teacher/notes', data),
   uploadPdfNote: (form)      => api.post('/teacher/notes/upload-pdf', form, { headers: { 'Content-Type': 'multipart/form-data' } }),
   ...
   getAnnouncements: (p)      => api.get('/teacher/announcements', { params: p }),
